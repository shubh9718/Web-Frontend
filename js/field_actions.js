...
function changeText() {
  ...
  if (x.length > 0) {
    document.getElementById("fname").style.backgroundImage =
      "url('../images/active_tick.png')";
  } else {
    document.getElementById("fname").style.backgroundImage =
      "url('../images/dormanttick.png')";
  }
}
...
function changeCardNumber() {
  ...
  if (x.length == 19) {
    document.getElementById("card").style.backgroundImage =
      "url('../images/creditCardActive.png'),url('../images/active_tick.png')";
  } else {
    document.getElementById("card").style.backgroundImage =
      "url('../images/creditCardDormant.png'),url('../images/dormanttick.png')";
  }
}
...
function changeCVVNumber() {
  ...
  if (x.length == 3) {
    document.getElementById("cvv").style.backgroundImage =
      "url('../images/cvvActive.png'), url('../images/active_tick.png')";
  } else {
    document.getElementById("cvv").style.backgroundImage =
      "url('../images/cvvDormant.png'),url('../images/dormanttick.png')";
  }
}
...
function changeDate() {
  ...
  if (x.length == 5) {
    document.getElementById("mmyy").style.backgroundImage =
      "url('../images/active_tick.png')";
  } else {
    document.getElementById("mmyy").style.backgroundImage =
      "url('../images/dormanttick.png')";
